...
const EventNewsHandler = () => {
  ...
  const fetchNews = ({ page = 1 }) => {
    httpClient
      .post(`get-my-event-news`, { page, limit: itemsPerPage })
      .then(async ({ data }) => {
        let formatData = await filterPaginationData({
          state: news,
          data: data?.news,
          page,
          countRoute: "/get-my-event-news-count",
        });
        setNews(formatData);
      })
      .catch((err) => {
              ...
              >
                ...
                <div className="sm:col-span-5 lg:col-span-5">
                  <div className="flex-1">
                    <Link
                      to={`${import.meta.env.VITE_CLIENT_DOMAIN}/event-news/${
                        item?.news_id
                      }`}
                    >
...
export default EventNewsHandler;
