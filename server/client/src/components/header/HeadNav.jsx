    ...
    return (
        <div className='relative w-full z-[100001] bg-white hidden sm:block'>
            <div className='flex items-center justify-between px-[1rem] sm:px-[2rem] md:px-[3rem] lg:px-[5rem]'>
                <img src={logoimg} alt="logoimg" className='w-[50%]  sm:w-[35%] md:w-[30%] lg:w-[28%]' />
                    ...
                    <ul>
                        ...
                        <li><Link href="/#">राज्य +</Link>
                            <ul className='dropdown-items'>
                                ...
                                <li><Link href="#">kalua +</Link>
                                    <ul>
                                        <li><Link href="#">sonbhadra</Link></li>
                                        <li><Link href="#">varanasi</Link></li>
                                        <li><Link href="#">jaunpur</Link></li>
                                        <li><Link href="#">prayagraj</Link></li>
                                    </ul>
                                </li>
                                <li><Link href="#">jackeline</Link></li>
                            </ul>
                        </li>
                        <li><Link href="/#">देश</Link></li>
                        <li><Link href="/#">विदेश</Link></li>
                        <li><Link href="/#">क्राइम</Link></li>
                        <li><Link href="/#">IPL 2024 </Link></li>
                        <li><Link href="/#">खेल कूद</Link></li>
                        <li><Link href="/#">धर्म</Link></li>
                        <li><Link href="/#">करियर</Link></li>
                    </ul>
                </nav>
            </header>
        </div>
